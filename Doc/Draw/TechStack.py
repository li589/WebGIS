...
tw = {
    ...
    "blue_box": "#DBEAFE",
    "blue_border": "#3B82F6",
    "blue_text": "#1E3A8A",  # 客户端层
    "amber_bg": "#FFFBEB",
    "amber_box": "#FEF08A",
    "amber_border": "#EAB308",
    "amber_text": "#713F12",  # 后端层
    "green_bg": "#F0FDF4",
    "green_box": "#BBF7D0",
    "green_border": "#22C55E",
    "green_text": "#14532D",  # 数据层
    "slate_bg": "#F8FAFC",
    "slate_box": "#E2E8F0",
    "slate_border": "#64748B",
    "slate_text": "#0F172A",  # 外部层
    "pink_box": "#FBCFE8",
    "pink_border": "#EC4899",
    "pink_text": "#831843",  # 特别高亮：计算/算法节点
}
...
draw_layer_panel(
    ...
    Y_BACK2 - 0.3,
    4.0,
    "后端服务层 (FastAPI + Celery + Python)",
    tw["amber_bg"],
    tw["amber_border"],
)
draw_layer_panel(
    ax, Y_DATA - 0.3, 2.1, "数据存储层", tw["green_bg"], tw["green_border"]
)
...
for i, (label, fc, ec) in enumerate(legend_items):
    rect = plt.Rectangle(
        (14.7, 10.5 - i * 0.5), 0.35, 0.25, facecolor=fc, edgecolor=ec, linewidth=1.5
    )
    ax.add_patch(rect)
...
ax.text(
    9.0,
    12.0,
    "3D Earth & 2D Map · Real-time Compute · GEE Integration",
    fontsize=12,
    ha="center",
    va="center",
    color="#64748B",
