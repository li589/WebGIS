...
def _build_5_node_workflow() -> dict[str, Any]:
    ...
    return {
        ...
        "nodes": [
            ...
            {
                "node_id": "temp_render",
                "node_type": "weather_temperature_grid",
                "params": {},
            },
            {
                "node_id": "precip_render",
                "node_type": "weather_precipitation_grid",
                "params": {},
            },
        ],
        "edges": [
            {
                ...
                "source_port": "forecast",
                "target_node_id": "parse",
                "target_port": "forecast",
            },
            {
                "source_node_id": "parse",
                "source_port": "weather_point",
                "target_node_id": "wind_render",
                "target_port": "weather_point",
            },
            {
                "source_node_id": "parse",
                "source_port": "weather_point",
                "target_node_id": "temp_render",
                "target_port": "weather_point",
            },
            {
                "source_node_id": "parse",
                "source_port": "weather_point",
                "target_node_id": "precip_render",
                "target_port": "weather_point",
            },
        ],
    }
