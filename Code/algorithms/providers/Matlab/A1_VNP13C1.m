...
path = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\HDF_2010_2014\VNP13C1_002-20260305_103320\';
path_sv1 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\2.NDVI_0.05_1014\temp\';
...
for i = 1:len
    ...
    command = [path_gdal,'gdal_translate.exe ','-a_ullr -180 90 180 -90 ',...
        '-a_srs EPSG:4326 ',...
        '-a_nodata -3000 ',...
        'HDF5:"',[path,hdfname],'"://HDFEOS/GRIDS/VIIRS_Grid_16Day_VI_CMG/Data_Fields/CMG_0.05_Deg_16_days_NDVI ',...
        [path_sv1,tifname1]];
    ...
    command = [path_gdal,'gdal_translate.exe ','-a_ullr -180 90 180 -90 ',...
        '-a_srs EPSG:4326 ',...
        '-a_nodata 5 ',...
        'HDF5:"',[path,hdfname],'"://HDFEOS/GRIDS/VIIRS_Grid_16Day_VI_CMG/Data_Fields/CMG_0.05_Deg_16_days_pixel_reliability ',...
        [path_sv1,tifname2]];
    [~,cmdout] = system(command);
...
%% 2) 转换投影
path_sv1 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\2.NDVI_0.05_1014\temp\';
path_sv2 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\2.NDVI_0.05_1014\temp1\';
...
%% 3)对NDVI做计算和处理
path_sv2 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\2.NDVI_0.05_1014\temp1\';
path_sv3 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\2.NDVI_0.05_1014\NDVI\';
...
for i = 1:len
 name_ndvi = namelist1(i).name;
    ...
    NDVI(NDVI>10000 | NDVI<-2000 | QA>=2) = nan;
    NDVI = NDVI*0.0001;
    % save
...
path_sv3 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\2.NDVI_0.05_1014\NDVI\';
path_sv4 = 'D:\DDCAfuxian\DDCAdata\VNP13C1002\3.NDVI_9km_1014\';
