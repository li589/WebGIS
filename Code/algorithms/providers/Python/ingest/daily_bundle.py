...
class DailyBundleConfig:
    ...
    tbh_aliases: tuple[str, ...] = ("TBh", "tbh")
    ia_aliases: tuple[str, ...] = ("IA", "Theta", "theta")
    ts_aliases: tuple[str, ...] = ("Ts", "ts")
    vwc_aliases: tuple[str, ...] = ("vwc",)
    smap_sm_aliases: tuple[str, ...] = ("sm_dca", "SM", "sm")
    ddca_sm_aliases: tuple[str, ...] = ("SM", "sm_dca", "sm")
    ndvi_daily_aliases: tuple[str, ...] = ("NDVI",)
    landcover_aliases: tuple[str, ...] = ("IGBP_9km_12",)
    lat_aliases: tuple[str, ...] = ("lat_9km",)
    lon_aliases: tuple[str, ...] = ("lon_9km",)
...
def build_daily_bundle_config(params: Mapping[str, Any]) -> DailyBundleConfig:
    ...
    return DailyBundleConfig(
        ...
        tbh_aliases=normalize_aliases_param(params_dict.get("tbh_aliases"), ("TBh", "tbh")),
        ia_aliases=normalize_aliases_param(params_dict.get("ia_aliases"), ("IA", "Theta", "theta")),
        ts_aliases=normalize_aliases_param(params_dict.get("ts_aliases"), ("Ts", "ts")),
        vwc_aliases=normalize_aliases_param(params_dict.get("vwc_aliases"), ("vwc",)),
        smap_sm_aliases=normalize_aliases_param(params_dict.get("smap_sm_aliases"), ("sm_dca", "SM", "sm")),
        ...
        lat_aliases=normalize_aliases_param(params_dict.get("lat_aliases"), ("lat_9km",)),
        lon_aliases=normalize_aliases_param(params_dict.get("lon_aliases"), ("lon_9km",)),
        ...
        clay_fraction_aliases=normalize_aliases_param(params_dict.get("clay_fraction_aliases"), ("CF",)),
