...
MODULE_REQUEST_TEMPLATES: dict[str, RequestTemplateSpec] = {
    ...
    "omega_sf_fenkuai": RequestTemplateSpec(
        ...
        allowed_task_types=("omega_sf_fenkuai", "workflow"),
        allowed_algorithm_values={
            "tb_source": ("FY", "SMAP"),
            "sm_source": ("SMAP", "ISMN", "DDCA"),
            "fy_platform": ("3D", "3B"),
            "temp_scheme": ("ORIG_TS", "DUAL"),
            "sf_mode": ("STATIC", "INVERTED_DAILY"),
            "sf_invert_mode": ("POINT1", "NDVIMIN"),
            "ndvi_mode": ("DAILY_FILE", "DOY_CLIM"),
            "omega_fixed_mode": ("PFT", "PIXEL"),
        },
    ),
}
