...
const _CRS_DEFS: CRSDef[] = [
  ...
  // ── EASE-Grid 家族扩展（proj4 串与后端 pyproj 输出一致）──
  {
    code: 'EPSG:6931',
  ...
  },
  {
    ...
    category: 'projected',
    epsg: 3408,
    proj4Def: '+proj=laea +lat_0=90 +lon_0=0 +x_0=0 +y_0=0 +R=6371228 +units=m +no_defs +type=crs',
    area: 'North',
    deprecated: false,
  },
  {
  ...
  },
  {
    ...
    category: 'projected',
    epsg: 3410,
    proj4Def: '+proj=cea +lat_ts=30 +lon_0=0 +x_0=0 +y_0=0 +R=6371228 +units=m +no_defs +type=crs',
    area: 'Global',
    deprecated: false,
  },
  {
