...
const _CRS_DEFS: CRSDef[] = [
  ...
  { code: 'EPSG:6933', label: 'EASE-Grid 2.0 全球等积圆柱投影', category: 'projected', epsg: 6933,
    ...
    area: 'Global', deprecated: false },
  { code: 'EPSG:32649', label: 'UTM Zone 49N（通用横轴墨卡托 49 带 北半球）', category: 'projected', epsg: 32649,
    proj4Def: '+proj=utm +zone=49 +datum=WGS84 +units=m +no_defs', area: 'China', deprecated: false },
  { code: 'EPSG:32650', label: 'UTM Zone 50N（通用横轴墨卡托 50 带 北半球）', category: 'projected', epsg: 32650,
  ...
  { code: 'EPSG:3034', label: 'ETRS89 / LCC Europe（欧洲兰伯特等角圆锥）',
    category: 'projected', epsg: 3034,
    proj4Def: '+proj=lcc +lat_1=35 +lat_2=65 +lat_0=52 +lon_0=10 +x_0=4000000 +y_0=2800000 +ellps=GRS80 +units=m +no_defs',
