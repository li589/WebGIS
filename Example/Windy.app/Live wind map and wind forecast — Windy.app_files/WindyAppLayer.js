const windyAppLayer = {
    ...
    setData() {
        ...
        this.texTimeout = setTimeout(() => {
            ...
            dispatchEvent(new CustomEvent('windyapp_map_data_applied', {
                detail: {
                    type: this.dataType
                }
            }));
    ...
    onAdd(map, gl) {
        ...
        this.vertexIds = new Float32Array(Array.from({
            length: arrLen
        }, (v, i) => i + latFrom * 2));
