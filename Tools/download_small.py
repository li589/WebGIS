...
from download_curated import FileBrowserClient, LOCAL_ROOT, SERVERS, DOWNLOAD_LIST, _format_size
...
def main():
    ...
    # 已知大文件（> 500 MB）的路径关键词
    large_keywords = ["ESACCI-BIOMASS", "ERA5_20", "ERA5_2019_SMCI", "ERA5_2018_SMCI",
                      "hfp2018", "CLCD_v01_1997_albert", "CLCD_v01_1997.tif",
                      "Landscape_Metrics", "Forest_Ratio"]
