...
RENAME_PLAN = [
    ...
    ("Hazards/全球\u201c复合灾害\u201d数据集 (1980-2020年)", "GlobalCompoundDisaster_1980_2020"),
    ("Hazards/干旱指数", "DroughtIndex"),
    ("Hazards/滑坡数据", "Landslide"),
    ("Hazards/火灾数据", "FireData"),

    # ── Hazards/GlobalCompoundDisaster 子目录 ──
    ("Hazards/GlobalCompoundDisaster_1980_2020/1989-2018全球重大洪水shp", "Flood_1989_2018_shp"),
    ...
    ("Hazards/GlobalCompoundDisaster_1980_2020/复合灾害shp数据", "CompoundDisaster_shp"),
    ("Hazards/GlobalCompoundDisaster_1980_2020/导出", "Exported"),

    # ── Hazards/Landslide 子目录 ──
    ("Hazards/Landslide/1915-2021年全球滑坡点及滑坡区域数据", "GlobalLandslide_1915_2021"),
    ("Hazards/Landslide/CNDD-0119 中国自然灾害影响及损失", "CNDD_ChinaDisasterLoss"),
    ("Hazards/Landslide/中国大陆显著滑坡地震数据集（2000-2023）", "ChinaMainlandLandslideEarthquake_2000_2023"),
    ("Hazards/Landslide/全国地质灾害shp", "ChinaGeoHazard_shp"),
    ("Hazards/Landslide/全球紧急事件数据库（1900-2025.2）", "GlobalEmergencyDB_1900_2025"),
...
def main() -> None:
    ...
    print(f"按深度从深到浅执行（深度 {plan_with_depth[0][0]} → {plan_with_depth[-1][0]}）")
    print()
