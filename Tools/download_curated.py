...
DOWNLOAD_LIST: list[tuple[str, str, str, str]] = [
    ...
    (
        "nas",
        "/Wangc/SWAP L3/SMAP_L3_SM_P_20230110_R18290_001.h5",
        "SMAP",
        "SMAP L3 SM 2023-01-10",
    ),
    (
        "nas",
        "/Wangc/SWAP L3/SMAP_L3_SM_P_20230118_R18290_001.h5",
        "SMAP",
        "SMAP L3 SM 2023-01-18",
    ),
    (
        "nas",
        "/Wangc/SWAP L3/SMAP_L3_SM_P_20230126_R18290_001.h5",
        "SMAP",
        "SMAP L3 SM 2023-01-26",
    ),
    (
        "nas",
        "/Wangc/SWAP L3/SMAP_L3_SM_P_20230129_R18290_001.h5",
        "SMAP",
        "SMAP L3 SM 2023-01-29",
    ),
    # SMAP L3 SM P E (被动+主动, 50 MB each) - 补充数据
    (
        "nas",
        "/Chenhaojun/Data/smap缺的日期/SMAP_L3_SM_P_E_20220920_R19240_001.h5",
        "SMAP",
        "SMAP L3 SM P_E 2022-09-20",
    ),
    # ── 2. CMFD 月数据（中国区域气象驱动数据）── 目标: Weather\
    (
        "nas",
        "/Wangc/CMFD/Data_forcing_01mo_010deg/lrad_CMFD_V0106_B-01_01mo_010deg_197901-201812.nc",
        "Weather",
        "CMFD 月均长波辐射 1979-2018",
    ),
    (
        "nas",
        "/Wangc/CMFD/Data_forcing_01mo_010deg/srad_CMFD_V0106_B-01_01mo_010deg_197901-201812.nc",
        "Weather",
        "CMFD 月均短波辐射 1979-2018",
    ),
    ...
    (
        "nas",
        "/LiuSJ/Data/MCD12Q1_China/MCD12Q1_2019.tif",
        "LandCover",
        "MCD12Q1 China 2019",
    ),
    (
        "nas",
        "/LiuSJ/Data/MCD12Q1_China/MCD12Q1_2020.tif",
        "LandCover",
        "MCD12Q1 China 2020",
    ),
    (
        "nas",
        "/LiuSJ/Data/MCD12Q1_China/MCD12Q1_2021.tif",
        "LandCover",
        "MCD12Q1 China 2021",
    ),
    ...
    (
        "nas",
        "/Wangxd/china1km/pre_tif/pre_2002_01.tif",
        "Precipitation",
        "China 1km precip 2002-01",
    ),
    (
        "nas",
        "/Wangxd/china1km/pre_tif/pre_2002_02.tif",
        "Precipitation",
        "China 1km precip 2002-02",
    ),
    (
        "nas",
        "/Wangxd/china1km/pre_tif/pre_2002_03.tif",
        "Precipitation",
        "China 1km precip 2002-03",
    ),
    (
        "nas",
        "/Wangxd/china1km/tmp_tif/tmp_2002_01.tif",
        "Weather",
        "China 1km temp 2002-01",
    ),
    (
        "nas",
        "/Wangxd/china1km/tmp_tif/tmp_2002_02.tif",
        "Weather",
        "China 1km temp 2002-02",
    ),
    (
        "nas",
        "/Wangxd/china1km/tmp_tif/tmp_2002_03.tif",
        "Weather",
        "China 1km temp 2002-03",
    ),
    # ── 4. 静态/小文件 ──
    # omega 反演结果 .mat → Inversion_Results\
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_017.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 017",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_018.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 018",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_019.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 019",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_020.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 020",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_021.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 021",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_022.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 022",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_023.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 023",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_024.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 024",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_025.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 025",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_026.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 026",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_027.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 027",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_028.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 028",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_029.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 029",
    ),
    (
        "nas",
        "/Liuzheng/omega_final/smap_avg_ω/doy_030.mat",
        "Inversion_Results",
        "omega SMAP avg DOY 030",
    ),
    # omega FY avg
    (
        "nas",
    ...
    (
        "nas",
        "/Liuzheng/ISMN和FLUXz站点匹配/ISMN_vs_Fluxnet2015.csv",
        "Station",
        "ISMN vs FLUXNET site matching",
    ),
    # Landscape Metrics → Inversion_Results\
    (
        "nas",
        "/Liuzheng/Data/Landscape_Metrics_LandOnly_9KM_2020.mat",
        "Inversion_Results",
        "Landscape Metrics 9KM 2020",
    ),
    (
        "nas",
        "/Liuzheng/Data/Forest_Ratio_9KM_2020.mat",
        "Inversion_Results",
    ...
    (
        "nas",
        "/Liuzheng/Data/AI/AridityIndex_MSWEP-prcp_div_GLEAM-Ep_1980-2020.tif",
        "Others",
        "Aridity Index 1980-2020",
    ),
]
    ...
    for server_key, items in by_server.items():
        ...
        for i, (remote_path, local_subdir, desc) in enumerate(items, 1):
            ...
            if local_path.exists():
                print(
                    f"  [{i}/{len(items)}] SKIP (exists): {filename} -> {local_subdir}\\"
                )
                total_skipped += 1
                continue
